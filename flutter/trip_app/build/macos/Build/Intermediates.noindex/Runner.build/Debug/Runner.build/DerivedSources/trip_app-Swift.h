...
#ifndef TRIP_APP_SWIFT_H
#define TRIP_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="trip_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8trip_app11AppDelegate")
...
SWIFT_CLASS("_TtC8trip_app17MainFlutterWindow")
